...
self.canvas = Canvas(self.tk, width = 500, height = 500, \
  highlightthickness = 0) 18. Доделываем игру 269
self.canvas.pack()
self.tk.update()
...
def collided_left(co1, co2):
  if within_y(co1, co2):
  if co1.x1 <= co2.x2 and co1.x1 >= co2.x1: 270 Часть III.Пишем игру« Человечек спешит к выходу»
return True
return False
...
self.images_right = [
  ...
  PhotoImage(file = "figure-R2.gif"), 18. Доделываем игру 271
...
def coords(self): 272 Часть III.Пишем игру« Человечек спешит к выходу»
...
and collided_bottom(1, co, sprite_co):
  falling = False18.Доделываем игру 273
...
g.sprites.append(platform7) 274 Часть III.Пишем игру« Человечек спешит к выходу»
